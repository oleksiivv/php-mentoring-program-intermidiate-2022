...
$booksRepository = (new RepositoriesManagementService($entityManager))->getRepository(Book::class);
$httpService = new HttpService();

if (isset($_GET['delete'])) {
    $booksRepository->delete($_GET['delete']);
...
$totalNumberOfEntities = $booksRepository->getNumberOfRecords($searchCriteria);
?>
<!doctype html>
<html lang="en">
<head>
